    ...
    <main className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-4 border-t border-gray-100">
          ...
          {job.jobType && (<div><p className="text-xs text-gray-400 mb-1">Job type</p>
            <p className="text-sm font-medium text-gray-700">{job.jobType}</p></div>)}
          {job.salary && (<div><p className="text-xs text-gray-400 mb-1">Salary</p>
            <p className="text-sm font-medium text-gray-700">{job.salary}</p></div>)}
          {job.category && (<div><p className="text-xs text-gray-400 mb-1">Category</p>
            <p className="text-sm font-medium text-gray-700">{job.category}</p></div>)}
        </div>
